...
function MessageContainer() {
  ...
  return (
    <div className="max-sm:w-full md:min-w-[450px] max-sm:h-[calc(90vh-195px)] flex flex-col  animate__animated animate__fadeInRight">
      {!selectedConversation ? (
        ...
        <>
          ...
          <div className=" bg-gray-800 border-gray-600 px-4 py-2 mb-2  ml-2.5 flex gap-2 items-center rounded-lg ">
            <span className="label-text text-white text-sm">To:</span>
